...
export const slides = [
  `${ASSET_ROOT}/20260603233327-406778073a22feb7.jpg`,
  `${ASSET_ROOT}/20260603233349-bd5d2bee8c39cbcc.jpg`,
  `${ASSET_ROOT}/20260603233534-30c5388dc203eabe.jpg`,
]
...
export const studentRelated = [
  { label: 'Olimpiade Siswa SMA/MA/SMK', path: '/page/olimpiade-siswa-sma-ma-smk' },
...
export const announcementArticles = {
  ...
  'pengumuman-ketiga': [
    { paragraphs: ['evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).'] },
    loremSections[2],
    loremSections[3],
  ],
}
